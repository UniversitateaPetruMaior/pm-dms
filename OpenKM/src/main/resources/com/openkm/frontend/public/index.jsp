...
<link type="text/css" rel="alternate stylesheet" href="mediumfont.css"
	title="mediumfont">
<link type="text/css" rel="alternate stylesheet" href="bigfont.css"
	title="bigfont">
...
<body>
	...
	<div
		style="width: 0; height: 0; border: 0; position: absolute; top: 1px; left: 1px;">
		<div id="scannerApplet"></div>
		<div id="uploaderApplet"></div>
	</div>
	<!-- Download & Print documents needs this -->
	<div style="display: none; visibility: hidden;">
		<iframe src="" name="__download" id="__download"
			style="width: 0; height: 0; border: 0;"></iframe>
		<iframe src="" name="__print" id="__print"
			style="width: 0; height: 0; border: 0;"></iframe>
	</div>
</body>
</html>