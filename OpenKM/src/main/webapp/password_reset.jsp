...
<body onload="document.forms[0].elements[0].focus()">
	<div id="box">
		...
		<c:if test="${not empty resetOk}">
			<div id="ok" style="height: 35px">Password correctly reset and
				mail sent to ${resetOk}</div>
		...
		<div id="text">
			...
			<p>Please insert the user name of your registered user. A
				password reminder will be sent to your email address.</p>
		</div>
		<div id="form">
			<form name="resetForm" method="post" action="PasswordReset">
				<label for="username">Registered user name</label> <input
					name="username" id="username" type="text" /><br /> <br /> <input
