...
<link rel="stylesheet"
	href="<%=request.getContextPath() %>/css/mobile.css" type="text/css" />
<% } else { %>
<link rel="stylesheet"
					...
					<table>
						<tr>
							<td colspan="2" align="center"><img
								src="<%=request.getContextPath() %>/logo/login" border="0" /></td>
						</tr>
						<tr>
							<td colspan="2" align="center" style="padding-top: 25px;">
								<h2><%=exception.toString()%></h2> <% session.invalidate(); %>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center"><a
								href="<%=request.getContextPath()%>">Go to login page</a></td>
						</tr>
					</table>
				</form>
			</td>
