			...
			<table class="results" width="80%">
				<thead>
					<tr class="fuzzy">
						<td colspan="4" align="right">
							<form action="Config" method="get">
								<input type="hidden" name="action" value="list" /> <b>Property</b>
								<input type="text" name="filter" value="${filter}" size="35" />
					...
					<tr>
						...
						<th>Type</th>
						<th>Value</th>
						<th width="50px"><c:url value="Config" var="urlCheck">
								<c:param name="action" value="check" />
							</c:url> <c:url value="Config" var="urlExport">
								<c:param name="action" value="export" />
							</c:url> <a href="${urlCheck}"><img src="img/action/check.png"
								alt="Check" title="Check" /></a> &nbsp; <a href="${urlExport}"><img
								src="img/action/export_sql.png" alt="SQL export"
								title="SQL export" /></a></th>
					</tr>
				</thead>
				<tbody>
