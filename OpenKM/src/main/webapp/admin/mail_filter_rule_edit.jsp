		...
		<c:when test="${isAdmin}">
			...
			<ul id="breadcrumb">
				...
				<li class="path"><a href="${urlMailFilterList}">Mail
						filters</a></li>
				<li class="path"><a href="${urlMailFilterRuleList}">Mail
						filters rules</a></li>
			...
			<form action="MailAccount" id="form">
				...
				<input type="hidden" name="persist" value="${persist}" /> <input
					...
					type="hidden" name="mf_id" value="${mf_id}" /> <input
					type="hidden" name="mfr_id" value="${mfr.id}" />
				<table class="form" width="345px" align="center">
					<tr>
						<td nowrap="nowrap">Field</td>
						<td><select name="mfr_field">
