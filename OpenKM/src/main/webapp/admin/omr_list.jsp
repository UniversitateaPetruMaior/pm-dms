			...
			<table id="results" class="results" width="90%">
				<thead>
					<tr>
						...
						<th>Fields</th>
						<th>Active</th>
						<th width="100px"><c:url value="Omr" var="urlCreate">
								<c:param name="action" value="create" />
							</c:url> <a href="${urlCreate}"><img src="img/action/new.png"
								alt="New template" title="New template" /></a></th>
					</tr>
				</thead>
				<tbody>
						...
						<tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
							...
							<td align="center"><a href="${urlEdit}"><img
								...
								href="${urlDelete}"><img src="img/action/delete.png"
									alt="Delete" title="Delete" /></a> &nbsp; <c:if
									test="${om.fieldsFileName!=null && om.fieldsFileName ne ''}">
									<a href="${urlCheck}"><img src="img/action/check.png"
										alt="Check" title="Check" /></a>
								</c:if></td>
						</tr>
					</c:forEach>
				</tbody>
