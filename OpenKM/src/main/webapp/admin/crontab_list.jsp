	...
	<c:choose>
		<c:when test="${isAdmin}">
			<ul id="breadcrumb">
				...
				<li class="action"><a href="CronTab"> <img
			...
			<table class="results" width="90%">
				<tr>
					...
					<th>Last End</th>
					<th>Active</th>
					<th width="100px"><c:url value="CronTab" var="urlCreate">
							<c:param name="action" value="create" />
						</c:url> <a href="${urlCreate}"><img src="img/action/new.png"
							alt="New crontab" title="New crontab" /></a></th>
				</tr>
				<c:forEach var="ct" items="${crontabs}" varStatus="row">
					...
					<tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
						...
						<td><a href="${urlEdit}"><img src="img/action/edit.png"
								alt="Edit" title="Edit" /></a> &nbsp; <a href="${urlDelete}"><img
								src="img/action/delete.png" alt="Delete" title="Delete" /></a>
							&nbsp; <a href="${urlExecute}"><img
								src="img/action/signal.png" alt="Execute" title="Execute" /></a>
							&nbsp; <a href="${urlDownload}"><img
								src="img/action/download.png" alt="Download" title="Download" /></a>
						</td>
					</tr>
				</c:forEach>
			</table>
