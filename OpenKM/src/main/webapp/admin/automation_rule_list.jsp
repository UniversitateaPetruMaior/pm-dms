		...
		<c:when test="${isAdmin}">
			...
			<table class="results" width="70%">
				<tr>
					...
					<th>Exclusive</th>
					<th>Active</th>
					<th width="80px"><c:url value="Automation" var="urlCreate">
						...
						<tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
							...
							<td align="center"><a href="${urlEdit}"><img
								...
								href="${urlDelete}"><img src="img/action/delete.png"
									alt="Delete" title="Delete" /></a> &nbsp; <a
								href="${urlDefinition}"><img src="img/action/filter.png"
									alt="Definition" title="Definition" /></a></td>
						</tr>
					</c:forEach>
				</tr>
			</table>
