				...
				<c:forEach var="mf" items="${mailFilters}" varStatus="row">
					...
					<tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
						...
						<td><a href="${urlEdit}"><img src="img/action/edit.png"
							...
							&nbsp; <a href="${urlRule}"><img src="img/action/rule.png"
								alt="Rules" title="Rules" /></a></td>
					</tr>
				</c:forEach>
			</table>
		</c:when>
