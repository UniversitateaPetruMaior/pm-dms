			...
			<form action="RebuildIndexes">
				<table class="form" align="center" width="175px">
					<tr>
						...
						<td><input name="action" value="textExtractor" type="radio" /></td>
					</tr>
					<tr>
						<td>Lucene indexes</td>
						<td><input name="action" value="luceneIndexes" type="radio" /></td>
					</tr>
					<tr>
						<td>Optimize indexes</td>
						<td><input name="action" value="optimizeIndexes" type="radio" /></td>
					</tr>
					<tr>
						<td colspan="2" align="right"><input type="button"
							onclick="javascript:window.history.back()" value="Cancel"
							class="noButton" /> <input type="submit" value="Execute"
							class="yesButton" /></td>
					</tr>
				</table>
			</form>
