...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			<ul id="breadcrumb">
				<li class="path"><a href="Auth?action=roleList">Role list</a></li>
				<li class="action"><a href="Auth"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> User list
				</a></li>
			</ul>
			<br />
			<table class="results" width="40%">
				<thead>
					<tr>
						...
						<th width="50px"><c:url value="Auth" var="urlCreate">
