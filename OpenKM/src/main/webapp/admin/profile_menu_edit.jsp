		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.cancelCheckOutVisible}">
						<input name="prf_menu_edit_cancel_check_out_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.addSubscriptionVisible}">
						<input name="prf_menu_edit_add_subscription_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_add_subscription_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.removeSubscriptionVisible}">
						<input name="prf_menu_edit_remove_subscription_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_remove_subscription_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.addPropertyGroupVisible}">
						<input name="prf_menu_edit_add_property_group_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_add_property_group_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.updatePropertyGroupVisible}">
						<input name="prf_menu_edit_update_property_group_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_update_property_group_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.removePropertyGroupVisible}">
						<input name="prf_menu_edit_remove_property_group_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_remove_property_group_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfEdit.removeCategoryVisible}">
						<input name="prf_menu_edit_remove_category_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_edit_remove_category_visible"
