		...
		<c:when test="${isAdmin}">
			...
			<form action="CheckEmail">
				...
				<table class="form" width="250px">
					<tr>
						<td>From</td>
						<td><input type="text" name="from" size="25" value="${from}" /></td>
					</tr>
					<tr>
						<td>To</td>
						<td><input type="text" name="to" size="25" value="${to}" /></td>
					</tr>
					<tr>
						<td>Subject</td>
					...
					<tr>
						<td colspan="2"><textarea name="content" cols="60" rows="7">${content}</textarea></td>
					</tr>
					<tr>
