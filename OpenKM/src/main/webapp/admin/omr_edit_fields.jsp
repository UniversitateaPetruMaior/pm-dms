				...
				<table class="form" width="425px">
					...
					<tr>
						...
						<td valign="top"><c:if
								...
								<a href="${urlDownload}&type=2">${om.fieldsFileName}</a>
								<br />
							</c:if> <input class=":required :only_on_blur" type="file" name="file" />
						</td>
					</tr>
					<tr>
						<td colspan="2" align="right">
							<div id="buttons">
								<input type="button" onclick="javascript:window.history.back()"
									value="Cancel" class="noButton" /> <input type="submit"
									value="Upload" class="yesButton" />
							</div>
						</td>
					</tr>
				</table>
