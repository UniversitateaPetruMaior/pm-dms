...
<fieldset>
	...
	<table>
		<tr>
			...
			<td><input class=":integer :only_on_blur"
				name="prf_misc_user_quota" value="${prf.prfMisc.userQuota}"
				size="10" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Web skin</td>
			<td><select name="prf_misc_web_skin">
					<c:choose>
					...
					<c:choose>
						<c:when test="${prf.prfMisc.webSkin == 'mediumfont'}">
							<option value="mediumfont" selected="selected">Medium
								font</option>
						</c:when>
						<c:otherwise>
							<option value="mediumfont">Medium font</option>
						</c:otherwise>
					</c:choose>
					<c:choose>
						...
						<c:otherwise>
							<option value="bigfont">Big font</option>
						</c:otherwise>
					</c:choose>
			</select></td>
		</tr>
		...
		<tr>
			<td>Extensions</td>
			<td><select multiple="multiple" name="prf_misc_extensions"
				size="4">
		...
		<tr>
			<td>Reports</td>
			<td><select multiple="multiple" name="prf_misc_reports" size="4">
		...
		<tr>
			<td>Workflows</td>
			<td><select multiple="multiple" name="prf_misc_workflows"
				size="4">
