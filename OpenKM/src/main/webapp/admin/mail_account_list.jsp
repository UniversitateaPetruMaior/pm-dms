		...
		<c:when test="${isAdmin}">
			...
			<table class="results" width="70%">
				<tr>
					...
					<th>Mail folder</th>
					<th>Active</th>
					<th width="100px"><c:url value="MailAccount" var="urlCreate">
							<c:param name="action" value="create" />
							<c:param name="ma_user" value="${ma_user}" />
						</c:url> <a href="${urlCreate}"><img src="img/action/new.png"
							alt="New account" title="New account" /></a></th>
				</tr>
				<c:forEach var="ma" items="${mailAccounts}" varStatus="row">
					...
					<tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
						...
						<td><a href="${urlEdit}"><img src="img/action/edit.png"
							...
							&nbsp; <a href="${urlFilter}"><img
								src="img/action/filter.png" alt="Filters" title="Filters" /></a>
							&nbsp; <a href="${urlServerList}"><img
								src="img/action/table.png" alt="Server List" title="Server List" /></a>
						</td>
					</tr>
				</c:forEach>
			</table>
