...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			<ul id="breadcrumb">
				<li class="path"><a href="TextExtractionQueue">Text
						extraction queue</a></li>
				...
				<li class="action"><a href="TextExtractionQueue"> <img
				...
				<thead>
					<tr class="fuzzy">
						<td colspan="4"
							...
							Extractions In Progress <c:if test="${inProgress}">
								<span
			...
			<table id="trick" class="results" width="90%">
				<thead>
					<tr class="fuzzy">
						<td colspan="4"
							style="text-align: center; font-weight: bold; font-size: 14px">
							Pending Extractions <c:if test="${!inProgress}">
								<span
									style="text-align: center; font-weight: bold; font-size: 12px">
									(Last execution: <c:choose>
					...
					<c:if test="${pendingSize > 0}">
						<tr class="fuzzy">
							<td colspan="4" style="text-align: center; font-weight: bold;">
								Total pending extractions: ${pendingSize}</td>
						</tr>
					</c:if>
				</tbody>
			</table>
