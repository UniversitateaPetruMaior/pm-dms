...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			...
			<ul id="breadcrumb">
				<li class="path"><a href="Auth">User list</a></li>
				<li class="action"><a href="Auth?action=roleList"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Role list
				</a></li>
				<li class="action"><a href="${messageList}"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Message queue
				</a></li>
				<li class="action"><a href="LoggedUsers"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Logged users
				</a></li>
			</ul>
			<br />
				...
				<tbody>
                  ...
                  ${role.id}
							...
							<td align="center"><c:if
									test="${multInstAdmin || user.id != Config.ADMIN_USER}">
									<c:choose>
										<c:when test="${db}">
											<c:choose>
												<c:when test="${user.active}">
													<a href="${urlActive}"><img src="img/true.png"
														alt="Active" title="Active" /></a>
												</c:when>
												<c:otherwise>
													<a href="${urlActive}"><img src="img/false.png"
														alt="Inactive" title="Inactive" /></a>
												</c:otherwise>
											</c:choose>
										</c:when>
										<c:otherwise>
							...
							<td align="center"><c:choose>
									<c:when test="${u:contains(chatUsers, user.id)}">
										<a href="${urlChatDisconnect}"><img
											src="img/action/chat_connected.png" alt="Disconnect user"
											title="Disconnect user" /></a>
									</c:when>
									<c:otherwise>
										<img src="img/action/chat_disconnected.png"
											alt="User disconnected" title="User disconnected" />
									</c:otherwise>
								</c:choose></td>
							<td align="center"><c:if
									test="${multInstAdmin || user.id != Config.ADMIN_USER}">
									<c:if test="${db}">
										<a href="${urlEdit}"><img src="img/action/edit.png"
											alt="Edit" title="Edit" /></a>
                    &nbsp;
                    <a href="${urlDelete}"><img
											src="img/action/delete.png" alt="Delete" title="Delete" /></a>
                    &nbsp;
                  </c:if>
									<a href="${urlConfig}"><img src="img/action/config.png"
										alt="User config" title="User config" /></a>
                  &nbsp;
                  <a href="${urlMail}"><img
										src="img/action/email.png" alt="Mail accounts"
										title="Mail accounts" /></a>
                  &nbsp;
                  <a href="${urlTwitter}"><img
										src="img/action/twitter.png" alt="Twitter accounts"
										title="Twitter accounts" /></a>
                  &nbsp;
                  <a href="${urlLog}"><img
