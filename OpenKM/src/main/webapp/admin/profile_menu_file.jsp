		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfFile.similarDocumentVisible}">
						<input name="prf_menu_file_similar_document_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfFile.createFromTemplateVisible}">
						<input name="prf_menu_file_create_from_template_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_file_create_from_template_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfFile.sendDocumentLinkVisible}">
						<input name="prf_menu_file_send_document_link_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_file_send_document_link_visible"
		...
		<tr>
			...
			<td><c:choose>
					<c:when test="${prf.prfMenu.prfFile.sendDocumentAttachmentVisible}">
						<input name="prf_menu_file_send_document_attachment_visible"
							type="checkbox" checked="checked" />
					</c:when>
					<c:otherwise>
						<input name="prf_menu_file_send_document_attachment_visible"
