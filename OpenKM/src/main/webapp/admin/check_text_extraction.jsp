...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			...
			<br />
			<form action="CheckTextExtraction" method="post"
				enctype="multipart/form-data">
				<table class="form" align="center">
					<tr>
						<td>Document UUID</td>
						<td colspan="2"><input name="docUuid" size="40"
							value="${docUuid}" /></td>
					</tr>
					<tr>
						<td>Document path</td>
						<td><input name="repoPath" id="repoPath" size="50"
							value="${repoPath}" /></td>
						<td><a class="ds"
							href="../extension/DataBrowser?action=repo&sel=doc&dst=repoPath&path=<u:getParent path="${repoPath}"/>"><img
