		...
		<c:when test="${isAdmin}">
			...
			<form action="Automation" id="form">
				...
				<input type="hidden" name="persist" value="${persist}" /> <input
					type="hidden" name="ar_id" value="${ar.id}" />
				<table class="form" width="345px" align="center">
					<tr>
						<td nowrap="nowrap">Order</td>
						<td><input size="4" maxlength="4"
							class=":integer :required :only_on_blur" name="ar_order"
							value="${ar.order}" id="ar_order" /></td>
					</tr>
					<tr>
						<td nowrap="nowrap">Name</td>
						<td><input size="30" maxlength="255"
							class=":required :only_on_blur" name="ar_name" value="${ar.name}"
							id="ar_name" /></td>
					</tr>
					<tr>
						<td nowrap="nowrap">Event</td>
						<td><select name="ar_event"
							class=":required :min_length;1 :only_on_blur" id="ar_event">
								<option value="">-</option>
					...
					<tr>
						...
						<td><select name="ar_at"
							class=":required :min_length;1 :only_on_blur" id="ar_at">
								<option value="">-</option>
