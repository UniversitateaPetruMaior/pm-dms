...
<body>
	...
	<c:choose>
		<c:when test="${isAdmin}">
			...
			<ul id="breadcrumb">
				<li class="path"><a href="DocumentExpiration">Document
						expiration</a></li>
				<li class="action"><a href="${urlClean}"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Clean
				</a></li>
				<li class="action"><a href="${urlSyncRoles}"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Sync Roles
				</a></li>
				<li class="action"><a href="${urlSyncUsers}"> <img
						src="img/action/generic.png" alt="Generic" title="Generic"
						style="vertical-align: middle;" /> Sync Users
				</a></li>
			</ul>
			<br />
			<table class="results" width="20%">
				<thead>
					<tr>
						...
						<th width="50px"><a href="${urlCreate}"><img
								src="img/action/new.png" alt="New group" title="New group" /></a></th>
					</tr>
				</thead>
