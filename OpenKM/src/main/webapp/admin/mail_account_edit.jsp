	...
	<c:choose>
		<c:when test="${isAdmin}">
			...
			<ul id="breadcrumb">
				...
				<li class="path"><a href="${urlMailAccountList}">Mail
						accounts</a></li>
			...
			<form action="MailAccount" id="form">
				...
				<input type="hidden" name="persist" value="${persist}" /> <input
					type="hidden" name="ma_id" value="${ma.id}" /> <input
					type="hidden" name="ma_user" value="${ma.user}" />
				<table class="form" width="345px" align="center">
					<tr>
						<td nowrap="nowrap">Mail protocol</td>
						<td><select name="ma_mprotocol">
					...
					<tr>
						...
						<td><input class=":required :only_on_blur" name="ma_mhost"
							value="${ma.mailHost}" size="26" /></td>
					</tr>
					<tr>
						<td nowrap="nowrap">Mail user</td>
						<td><input class=":required :only_on_blur" name="ma_muser"
							value="${ma.mailUser}" size="26" /></td>
					</tr>
					<tr>
						<td nowrap="nowrap">Mail password</td>
						<td><input class=":required :only_on_blur"
							name="ma_mpassword" type="password" value="${ma.mailPassword}"
							autocomplete="off" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="right"><input type="button" id="check"
							value="Check" class="executeButton" /> <input type="button"
