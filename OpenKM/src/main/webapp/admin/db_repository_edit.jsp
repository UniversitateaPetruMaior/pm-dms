	...
	<c:choose>
		<c:when test="${isAdmin}">
			<ul id="breadcrumb">
				...
				<li class="path"><a href="DbRepositoryView?uuid=${uuid}">Repository
						view</a></li>
				<li class="path">Repository edit</li>
			</ul>
			<br />
			<form action="DbRepositoryView" method="post">
				<input type="hidden" name="action" value="editPersist" /> <input
					type="hidden" name="uuid" value="${uuid}" /> <input type="hidden"
					name="group" value="${group}" /> <input type="hidden"
