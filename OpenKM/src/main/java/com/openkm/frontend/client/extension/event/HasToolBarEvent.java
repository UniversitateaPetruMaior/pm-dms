...
public interface HasToolBarEvent {
	...
	ToolBarEventConstant EXECUTE_CHECK_DOCUMENT_PERMISSION = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_CHECK_DOCUMENT_PERMISSION);
	ToolBarEventConstant EXECUTE_CHECK_FOLDER_PERMISSION = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_CHECK_FOLDER_PERMISSION);
	ToolBarEventConstant EXECUTE_CHECK_MAIL_PERMISSION = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_CHECK_MAIL_PERMISSION);
	ToolBarEventConstant EXECUTE_CHANGED_VIEW = new ToolBarEventConstant(ToolBarEventConstant.EVENT_CHANGED_VIEW);
	ToolBarEventConstant EXECUTE_CREATE_FOLDER = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_EXECUTE_CREATE_FOLDER);
	ToolBarEventConstant EXECUTE_FIND_FOLDER = new ToolBarEventConstant(ToolBarEventConstant.EVENT_EXECUTE_FIND_FOLDER);
	ToolBarEventConstant EXECUTE_FIND_DOCUMENT = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_EXECUTE_FIND_DOCUMENT);
	...
	ToolBarEventConstant EXECUTE_DOWNLOAD_DOCUMENT = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_DOWNLOAD_DOCUMENT);
	ToolBarEventConstant EXECUTE_DOWNLOAD_PDF_DOCUMENT = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_DOWNLOAD_PDF_DOCUMENT);
	ToolBarEventConstant EXECUTE_ADD_PROPERTY_GROUP = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_ADD_PROPERTY_GROUP);
	ToolBarEventConstant EXECUTE_ADD_WORKFLOW = new ToolBarEventConstant(ToolBarEventConstant.EVENT_ADD_WORKFLOW);
	ToolBarEventConstant EXECUTE_REMOVE_PROPERTY_GROUP = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_REMOVE_PROPERTY_GROUP);
	ToolBarEventConstant EXECUTE_ADD_SUBSCRIPTION = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_ADD_SUBSCRIPTION);
	ToolBarEventConstant EXECUTE_REMOVE_SUBSCRIPTION = new ToolBarEventConstant(
			ToolBarEventConstant.EVENT_REMOVE_SUBSCRIPTION);
