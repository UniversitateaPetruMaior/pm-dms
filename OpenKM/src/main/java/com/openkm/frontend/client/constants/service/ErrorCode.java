...
/**
 * Error code to determine more exactly by administrator the error cause without
 * needed to go to log file making general error codification for application
 * 
 * @author jllort
 */
public class ErrorCode {
	 ...
	 * ORIGIN_CODE_ERROR + CAUSE_CODE_ERROR example ERROR 001001 = Error causes
	 * on OKMFolderService and originated by Repository Exception
	 * 
