	...
	private void execute() {
		switch (action) {
			...
			case CONFIRM_DELETE_NOTE_FOLDER:
				if (object!=null && object instanceof NoteToDelete) {
					NoteToDelete noteToDelete = (NoteToDelete) object;
					Main.get().mainPanel.desktop.browser.tabMultiple.tabFolder.notes.deleteNote(noteToDelete.getNotePath(), noteToDelete.getRow());
				}
				break;
			...
			case CONFIRM_DELETE_NOTE_MAIL:
				if (object!=null && object instanceof NoteToDelete) {
					NoteToDelete noteToDelete = (NoteToDelete) object;
					Main.get().mainPanel.desktop.browser.tabMultiple.tabMail.notes.deleteNote(noteToDelete.getNotePath(), noteToDelete.getRow());
				}
				break;
