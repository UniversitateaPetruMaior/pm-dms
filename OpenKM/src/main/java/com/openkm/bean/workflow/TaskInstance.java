...
public class TaskInstance implements Serializable, Comparable<TaskInstance> {
	...
	public String toString() {
		...
		sb.append(", pooledActors="); sb.append(pooledActors);
		sb.append(", open="); sb.append(open);
		sb.append(", last="); sb.append(last);
		sb.append(", suspended="); sb.append(suspended);
		sb.append(", startTaskInstance="); sb.append(startTaskInstance);
		sb.append(", create="); sb.append(create==null?null:create.getTime());
		sb.append(", dueDate="); sb.append(dueDate==null?null:dueDate.getTime());
		...
		sb.append(", variables="); sb.append(variables);
