...
public class ProfileDashboard implements Serializable {
	...
	public String toString() {
		...
		sb.append("{");
		sb.append("userVisible="); sb.append(userVisible);
		sb.append(", mailVisible="); sb.append(mailVisible);
		sb.append(", newsVisible="); sb.append(newsVisible);
		sb.append(", generalVisible="); sb.append(generalVisible);
		sb.append(", workflowVisible="); sb.append(workflowVisible);
		sb.append(", keywordsVisible="); sb.append(keywordsVisible);
		sb.append("}");
		return sb.toString();
	}
}
