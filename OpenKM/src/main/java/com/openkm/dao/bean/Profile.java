...
public class Profile implements Serializable {
	...
	public String toString() {
		...
		sb.append(", prfStack="); sb.append(prfStack);
		sb.append(", prfTab="); sb.append(prfTab);
		sb.append(", prfWizard="); sb.append(prfWizard);
		sb.append(", prfToolbar="); sb.append(prfToolbar);
		sb.append(", prfFileBrowser="); sb.append(prfFileBrowser);
		sb.append("}");
		return sb.toString();
	}
}
