...
public class ProfileMenuHelp implements Serializable {
	...
	public String toString() {
		...
		sb.append(", documentationVisible="); sb.append(documentationVisible);
		sb.append(", bugTrackingVisible="); sb.append(bugTrackingVisible);
		sb.append(", supportVisible="); sb.append(supportVisible);
		sb.append(", forumVisible="); sb.append(forumVisible);
		sb.append(", changelogVisible="); sb.append(changelogVisible);
		sb.append(", webSiteVisible="); sb.append(webSiteVisible);
		sb.append(", aboutVisible="); sb.append(aboutVisible);
		sb.append("}");
		return sb.toString();
	}
}
