...
public class ProfileServlet extends BaseServlet {
	...
	private void create(String userId, HttpServletRequest request, HttpServletResponse response) throws ServletException,
			IOException, DatabaseException, RepositoryException, ParseException, WorkflowException {
	...
	private void edit(String userId, HttpServletRequest request, HttpServletResponse response) throws ServletException,
			IOException, DatabaseException, NoSuchAlgorithmException, RepositoryException, ParseException, WorkflowException {
	...
	private void clone(String userId, HttpServletRequest request, HttpServletResponse response) throws DatabaseException,
			IOException, ParseException, RepositoryException, WorkflowException, ServletException {
	...
	private Profile getUserProfile(HttpServletRequest request) {
		...
		prf.getPrfWizard()
				.setPropertyGroups(new HashSet<String>(WebUtils.getStringList(request, "prf_wizard_property_groups")));
		...
		// Explorer
		prf.getPrfExplorer().setTypeFilterEnabled(WebUtils.getBoolean(request, "prf_explorer_type_filter_enabled"));
		...
		// Menu File
		prf.getPrfMenu().getPrfFile()
				.setCreateFolderVisible(WebUtils.getBoolean(request, "prf_menu_file_create_folder_visible"));
		prf.getPrfMenu().getPrfFile().setFindFolderVisible(WebUtils.getBoolean(request, "prf_menu_file_find_folder_visible"));
		prf.getPrfMenu().getPrfFile()
				.setFindDocumentVisible(WebUtils.getBoolean(request, "prf_menu_file_find_document_visible"));
		prf.getPrfMenu().getPrfFile()
				.setSimilarDocumentVisible(WebUtils.getBoolean(request, "prf_menu_file_similar_document_visible"));
		...
		prf.getPrfMenu().getPrfFile()
				.setStartWorkflowVisible(WebUtils.getBoolean(request, "prf_menu_file_start_workflow_visible"));
		...
		prf.getPrfMenu().getPrfFile()
				.setCreateFromTemplateVisible(WebUtils.getBoolean(request, "prf_menu_file_create_from_template_visible"));
		...
		prf.getPrfMenu().getPrfFile()
				.setSendDocumentLinkVisible(WebUtils.getBoolean(request, "prf_menu_file_send_document_link_visible"));
		prf.getPrfMenu()
				.getPrfFile()
				.setSendDocumentAttachmentVisible(
						WebUtils.getBoolean(request, "prf_menu_file_send_document_attachment_visible"));
		
		// Menu Bookmarks
		prf.getPrfMenu().getPrfBookmark()
				.setManageBookmarksVisible(WebUtils.getBoolean(request, "prf_menu_bookmark_manage_bookmarks_visible"));
		prf.getPrfMenu().getPrfBookmark()
				.setAddBookmarkVisible(WebUtils.getBoolean(request, "prf_menu_bookmark_add_bookmark_visible"));
		...
		prf.getPrfMenu().getPrfTool()
				.setAdministrationVisible(WebUtils.getBoolean(request, "prf_menu_tool_administration_visible"));
		...
		prf.getPrfMenu().getPrfEdit()
				.setCancelCheckOutVisible(WebUtils.getBoolean(request, "prf_menu_edit_cancel_check_out_visible"));
		prf.getPrfMenu().getPrfEdit().setDeleteVisible(WebUtils.getBoolean(request, "prf_menu_edit_delete_visible"));
		prf.getPrfMenu().getPrfEdit()
				.setAddSubscriptionVisible(WebUtils.getBoolean(request, "prf_menu_edit_add_subscription_visible"));
		prf.getPrfMenu().getPrfEdit()
				.setRemoveSubscriptionVisible(WebUtils.getBoolean(request, "prf_menu_edit_remove_subscription_visible"));
		prf.getPrfMenu().getPrfEdit()
				.setAddPropertyGroupVisible(WebUtils.getBoolean(request, "prf_menu_edit_add_property_group_visible"));
		prf.getPrfMenu().getPrfEdit()
				.setRemovePropertyGroupVisible(WebUtils.getBoolean(request, "prf_menu_edit_remove_property_group_visible"));
		...
		prf.getPrfMenu().getPrfHelp()
				.setDocumentationVisible(WebUtils.getBoolean(request, "prf_menu_help_documentation_visible"));
		...
		// Tab Document
		prf.getPrfTab().getPrfDocument()
				.setPropertiesVisible(WebUtils.getBoolean(request, "prf_tab_document_properties_visible"));
		...
		prf.getPrfTab().getPrfDocument()
				.setVersionDownloadVisible(WebUtils.getBoolean(request, "prf_tab_document_version_download_visible"));
		prf.getPrfTab().getPrfDocument().setPreviewVisible(WebUtils.getBoolean(request, "prf_tab_document_preview_visible"));
		prf.getPrfTab().getPrfDocument()
				.setPropertyGroupsVisible(WebUtils.getBoolean(request, "prf_tab_document_property_groups_visible"));
		...
		prf.getPrfToolbar().setRemoveSubscriptionVisible(
				WebUtils.getBoolean(request, "prf_toolbar_remove_subscription_visible"));
